...
Get-Childitem -Path "$ProjectRoot\yumtop.mof","$ProjectRoot\gopher-world.mof","$ProjectRoot\cChoco","$ProjectRoot\xPSDesiredStateConfiguration" -Recurse | Compress-Archive -DestinationPath $ProjectRoot`.zip -Verbose
